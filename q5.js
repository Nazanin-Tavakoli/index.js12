...
const obj = {
    ...
    counterString(str) {
      ...
      // Calculate the length of each element in the array
      const lengths = wordsArray.map((word) => word.length);
  
      // Return a new array containing the lengths of the elements
      return lengths;
    },
  };